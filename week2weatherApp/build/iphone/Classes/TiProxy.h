...
//Rare exceptions to indicate a bug in the _week2weatherapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for week2weatherApp proxies.
 */
