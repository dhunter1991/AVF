...
/**
 Base class for all week2weatherApp views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the week2weatherApp view hierarchy (such as wrapped iOS UIViews) was touched.
