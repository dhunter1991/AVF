...
// in simulator we redefine to format for week2weatherApp Developer console
...
{\
	NSString * exceptionName = [@"org.week2weatherapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week2weatherapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIweek2weatherAppNativeItemNone = -1, 
	UIweek2weatherAppNativeItemSpinner = -2,
	UIweek2weatherAppNativeItemProgressBar = -3,
	
	UIweek2weatherAppNativeItemSlider = -4,
	UIweek2weatherAppNativeItemSwitch = -5,
	UIweek2weatherAppNativeItemMultiButton = -6,
	UIweek2weatherAppNativeItemSegmented = -7,
	
	UIweek2weatherAppNativeItemTextView = -8,
	UIweek2weatherAppNativeItemTextField = -9,
	UIweek2weatherAppNativeItemSearchBar = -10,
	
	UIweek2weatherAppNativeItemPicker = -11,
	UIweek2weatherAppNativeItemDatePicker = -12,
	
	UIweek2weatherAppNativeItemInfoLight = -13,
	UIweek2weatherAppNativeItemInfoDark = -14,
	
	UIweek2weatherAppNativeItemDisclosure = -15,
	
	UIweek2weatherAppNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all week2weatherApp instances of
