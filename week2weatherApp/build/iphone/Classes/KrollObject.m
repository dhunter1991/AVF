...
//@interface week2weatherAppObject : NSObject
//@end

@interface week2weatherAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[week2weatherAppObject class]])
		{
			for (NSString *key in [[(week2weatherAppObject*)o modules] allKeys])
			{
