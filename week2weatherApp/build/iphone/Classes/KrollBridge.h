...
@interface week2weatherAppObject : KrollCoverageObject {
#else
@interface week2weatherAppObject : KrollObject {
#endif
@private
...
extern NSString * week2weatherApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	week2weatherAppObject *_week2weatherapp;
    KrollObject* console;
	BOOL shutdown;
