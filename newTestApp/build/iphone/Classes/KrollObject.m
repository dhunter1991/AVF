...
//@interface newTestAppObject : NSObject
//@end

@interface newTestAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[newTestAppObject class]])
		{
			for (NSString *key in [[(newTestAppObject*)o modules] allKeys])
			{
