...
@interface newTestAppObject : KrollCoverageObject {
#else
@interface newTestAppObject : KrollObject {
#endif
@private
...
extern NSString * newTestApp$ModuleRequireFormat;
