...
// in simulator we redefine to format for newTestApp Developer console
...
{\
	NSString * exceptionName = [@"org.newtestapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.newtestapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UInewTestAppNativeItemNone = -1, 
	UInewTestAppNativeItemSpinner = -2,
	UInewTestAppNativeItemProgressBar = -3,
	
	UInewTestAppNativeItemSlider = -4,
	UInewTestAppNativeItemSwitch = -5,
	UInewTestAppNativeItemMultiButton = -6,
	UInewTestAppNativeItemSegmented = -7,
	
	UInewTestAppNativeItemTextView = -8,
	UInewTestAppNativeItemTextField = -9,
	UInewTestAppNativeItemSearchBar = -10,
	
	UInewTestAppNativeItemPicker = -11,
	UInewTestAppNativeItemDatePicker = -12,
	
	UInewTestAppNativeItemInfoLight = -13,
	UInewTestAppNativeItemInfoDark = -14,
	
	UInewTestAppNativeItemDisclosure = -15,
	
	UInewTestAppNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all newTestApp instances of
