...
/**
 Base class for all newTestApp views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the newTestApp view hierarchy (such as wrapped iOS UIViews) was touched.
