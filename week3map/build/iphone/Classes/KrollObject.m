...
//@interface week3mapObject : NSObject
//@end

@interface week3mapObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[week3mapObject class]])
		{
			for (NSString *key in [[(week3mapObject*)o modules] allKeys])
			{
