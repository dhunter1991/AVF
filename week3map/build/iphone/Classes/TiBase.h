...
// in simulator we redefine to format for week3map Developer console
...
{\
	NSString * exceptionName = [@"org.week3map." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week3map";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIweek3mapNativeItemNone = -1, 
	UIweek3mapNativeItemSpinner = -2,
	UIweek3mapNativeItemProgressBar = -3,
	
	UIweek3mapNativeItemSlider = -4,
	UIweek3mapNativeItemSwitch = -5,
	UIweek3mapNativeItemMultiButton = -6,
	UIweek3mapNativeItemSegmented = -7,
	
	UIweek3mapNativeItemTextView = -8,
	UIweek3mapNativeItemTextField = -9,
	UIweek3mapNativeItemSearchBar = -10,
	
	UIweek3mapNativeItemPicker = -11,
	UIweek3mapNativeItemDatePicker = -12,
	
	UIweek3mapNativeItemInfoLight = -13,
	UIweek3mapNativeItemInfoDark = -14,
	
	UIweek3mapNativeItemDisclosure = -15,
	
	UIweek3mapNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all week3map instances of
