...
/**
 The base class for all mapAppWeek4 modules
 */
...
/**
 mapAppWeek4 Platform calls this method on startup.
 */
-(void)startup;

/**
 mapAppWeek4 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 mapAppWeek4 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 mapAppWeek4 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 mapAppWeek4 Platform calls this method on resume.
 @param sender The sender of the event.
 */
