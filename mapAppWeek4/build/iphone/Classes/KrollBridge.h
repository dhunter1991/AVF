...
@interface mapAppWeek4Object : KrollCoverageObject {
#else
@interface mapAppWeek4Object : KrollObject {
#endif
@private
...
extern NSString * mapAppWeek4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	mapAppWeek4Object *_mapappweek4;
    KrollObject* console;
	BOOL shutdown;
