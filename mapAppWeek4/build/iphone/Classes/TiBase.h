...
// in simulator we redefine to format for mapAppWeek4 Developer console
...
{\
	NSString * exceptionName = [@"org.mapappweek4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mapappweek4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UImapAppWeek4NativeItemNone = -1, 
	UImapAppWeek4NativeItemSpinner = -2,
	UImapAppWeek4NativeItemProgressBar = -3,
	
	UImapAppWeek4NativeItemSlider = -4,
	UImapAppWeek4NativeItemSwitch = -5,
	UImapAppWeek4NativeItemMultiButton = -6,
	UImapAppWeek4NativeItemSegmented = -7,
	
	UImapAppWeek4NativeItemTextView = -8,
	UImapAppWeek4NativeItemTextField = -9,
	UImapAppWeek4NativeItemSearchBar = -10,
	
	UImapAppWeek4NativeItemPicker = -11,
	UImapAppWeek4NativeItemDatePicker = -12,
	
	UImapAppWeek4NativeItemInfoLight = -13,
	UImapAppWeek4NativeItemInfoDark = -14,
	
	UImapAppWeek4NativeItemDisclosure = -15,
	
	UImapAppWeek4NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all mapAppWeek4 instances of
