...
//@interface mapAppWeek4Object : NSObject
//@end

@interface mapAppWeek4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[mapAppWeek4Object class]])
		{
			for (NSString *key in [[(mapAppWeek4Object*)o modules] allKeys])
			{
